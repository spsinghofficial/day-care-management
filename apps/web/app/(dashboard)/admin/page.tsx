    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Welcome to your daycare management center
        </p>
      </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{stats.totalChildren}</dd>
                </dl>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-gray-900">Manage Children</p>
                <p className="text-sm text-gray-500">View and manage enrolled children</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">Invite and manage staff members</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <span className="absolute inset-0" />
                <p className="text-sm font-medium text-gray-900">Manage Classrooms</p>
                <p className="text-sm text-gray-500">Set up and organize classrooms</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">Configure daycare settings</p>
              </div>
            </Link>
          </div>
        </div>
